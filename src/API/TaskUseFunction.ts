async function GetTasksFunction() {
    try {
        const response = await fetch('https://to-do-server-w0ax.onrender.com/tasks/getTasks', {
            method: "POST",
            headers: {
...
async function CreateTaskFunction(taskName:string, passwordDescription:string, username:null | string) {
    fetch('https://to-do-server-w0ax.onrender.com/tasks/createTask', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function DeleteTaskFunction(username: string | null, taskId:string) {
    fetch('https://to-do-server-w0ax.onrender.com/tasks/deleteTask', {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function UpdateTaskMarkerFunction(markerValue:string, taskId:string) {
    fetch('https://to-do-server-w0ax.onrender.com/tasks/updateTaskMarker', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function ChangeTaskFunction(taskName:string, taskDescription:string, taskId:string) {
    fetch('https://to-do-server-w0ax.onrender.com/tasks/changeTask', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
